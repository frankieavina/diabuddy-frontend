...
const BottomTabNavigator = () => {
  return (
    <Tab.Navigator screenOptions={{ headerShown: false }}>
      <Tab.Screen name="Home" component={DashboardScreen} options={{ tabBarIcon: ({color,size}) => (<Ionicons name='home' color={color} size={size}/>) }}/>
      <Tab.Screen name="Basal" component={AddFoodScreen} options={{ tabBarIcon: ({color,size}) => (<Ionicons name='nutrition' color={color} size={size}/>) }}/>
