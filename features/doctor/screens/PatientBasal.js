...
import BasalList from '../../administrator/screens/BasalList';
...
const PatientBasal = () => {
  ...
  return (
    <View style={{flex:1}}>
      ...
      >
      <View>
        <Text style={styles.titleText}>Basal Test Patient's History</Text>
        <Text style={styles.infoText}> 
          Please select specific patient to view data
        </Text>
      </View>
      { (isLoading) ? (
          <Loading />
